...
public class Doctor {
   ...
   public Doctor(String firstName, String lastName, String email, String password, LocalDate dob, String address,
		String phone, Gender gender, double fees, DoctorSpecialization doctorSpecialization) {
	super();
   ...
   public List<Appointment> getAppointments() {
	...
	public String toString() {
		return "Doctor [doctor_id=" +doctorId  + ", firstName=" + firstName + ", lastName=" + lastName + ", email="
				+ email + ", password=" + password + ", dob=" + dob + ", address=" + address + ", phone=" + phone
				+ ", gender=" + gender + ", fees=" + fees + ", doctorSpecialization=" + doctorSpecialization + "]";
	}
